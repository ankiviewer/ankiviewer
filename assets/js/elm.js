...
var _user$project$Main$formatDate = function (mod) {
	var date = _elm_lang$core$Date$fromTime(
		_elm_lang$core$Basics$toFloat(mod * 1000));
	return A2(
...
var _user$project$Main$Model = F5(
	function (a, b, c, d, e) {
		return {phxSocket: a, collection: b, error: c, syncingDatabase: d, syncingDatabaseMsg: e};
	});
var _user$project$Main$SyncMsg = function (a) {
	return {syncMsg: a};
};
var _user$project$Main$syncDatabaseMsgDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'msg',
	_elm_lang$core$Json_Decode$string,
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Main$SyncMsg));
var _user$project$Main$Collection = F2(
	function (a, b) {
		return {mod: a, notes: b};
	});
var _user$project$Main$collectionDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'notes',
	...
	A3(
		...
		'mod',
		_elm_lang$core$Json_Decode$int,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Main$Collection)));
var _user$project$Main$NoOp = {ctor: 'NoOp'};
var _user$project$Main$NewCollection = function (a) {
	return {ctor: 'NewCollection', _0: a};
};
var _user$project$Main$getCollection = A2(
	_elm_lang$http$Http$send,
	_user$project$Main$NewCollection,
	A2(_elm_lang$http$Http$get, '/api/collection', _user$project$Main$collectionDecoder));
var _user$project$Main$GetCollection = {ctor: 'GetCollection'};
var _user$project$Main$SyncDatabaseMsg = function (a) {
	return {ctor: 'SyncDatabaseMsg', _0: a};
};
var _user$project$Main$SyncDatabaseLeave = function (a) {
	return {ctor: 'SyncDatabaseLeave', _0: a};
};
var _user$project$Main$initialPhxSocket = A4(
	_fbonetti$elm_phoenix_socket$Phoenix_Socket$on,
	'done',
	'sync:database',
	_user$project$Main$SyncDatabaseLeave,
	A4(
		_fbonetti$elm_phoenix_socket$Phoenix_Socket$on,
		'sync:msg',
		'sync:database',
		_user$project$Main$SyncDatabaseMsg,
		_fbonetti$elm_phoenix_socket$Phoenix_Socket$init(_user$project$Main$socketServer)));
var _user$project$Main$initialModel = {
	phxSocket: _user$project$Main$initialPhxSocket,
	collection: {mod: 0, notes: 0},
	error: false,
	syncingDatabase: false,
	syncingDatabaseMsg: ''
};
var _user$project$Main$init = {ctor: '_Tuple2', _0: _user$project$Main$initialModel, _1: _user$project$Main$getCollection};
var _user$project$Main$StopSpinner = {ctor: 'StopSpinner'};
var _user$project$Main$SyncDatabase = {ctor: 'SyncDatabase'};
var _user$project$Main$view = function (_p0) {
	var _p1 = _p0;
	var _p4 = _p1.syncingDatabase;
	var _p3 = _p1.error;
	var _p2 = _p1.collection;
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$SyncDatabase),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$disabled(_p4),
						_1: {
							ctor: '::',
							_0: A2(_elm_lang$html$Html_Attributes$attribute, 'data-label', 'Sync Database'),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$classList(
									{
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: 'sync-button', _1: true},
										_1: {
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: 'syncing', _1: _p4},
											_1: {ctor: '[]'}
										}
									}),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$id('load-button'),
									_1: {ctor: '[]'}
								}
							}
						}
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Sync Database'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$div,
					{
						...
						_0: _elm_lang$html$Html_Attributes$classList(
							{
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'dn', _1: !(_p4 || _p3)},
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'red', _1: _p3},
									_1: {ctor: '[]'}
								}
							}),
						_1: {ctor: '[]'}
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(_p1.syncingDatabaseMsg),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
								...
								{ctor: '[]'},
								{
									...
									_0: _elm_lang$html$Html$text(
										A2(
											_elm_lang$core$Basics_ops['++'],
											'last modified: ',
											_user$project$Main$formatDate(_p2.mod))),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
									...
									{ctor: '[]'},
									{
										...
										_0: _elm_lang$html$Html$text(
											A2(
												_elm_lang$core$Basics_ops['++'],
												'number notes: ',
												_elm_lang$core$Basics$toString(_p2.notes))),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
...
var _user$project$Main$PhxMsg = function (a) {
	return {ctor: 'PhxMsg', _0: a};
};
			...
			switch (_p5.ctor) {
				case 'PhxMsg':
					...
					return A2(
						...
						{
							ctor: '::',
							_0: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$PhxMsg, phxCmd),
							_1: {ctor: '[]'}
						});
				case 'SyncDatabase':
					var channel = _fbonetti$elm_phoenix_socket$Phoenix_Channel$init('sync:database');
					var _p7 = A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$join, channel, _user$project$Main$initialPhxSocket);
					...
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{phxSocket: phxSocket, syncingDatabase: true}),
						{
							ctor: '::',
							_0: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$PhxMsg, phxCmd),
							_1: {ctor: '[]'}
						});
				case 'SyncDatabaseMsg':
					if (model.error) {
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							model,
						...
						var _p8 = A2(_elm_lang$core$Json_Decode$decodeValue, _user$project$Main$syncDatabaseMsgDecoder, _p5._0);
						if (_p8.ctor === 'Ok') {
							return A2(
								_elm_lang$core$Platform_Cmd_ops['!'],
								_elm_lang$core$Native_Utils.update(
									model,
									{syncingDatabaseMsg: _p8._0.syncMsg}),
								{ctor: '[]'});
						} else {
							var _v3 = _user$project$Main$SyncDatabaseLeave(_elm_lang$core$Json_Encode$null),
								_v4 = _elm_lang$core$Native_Utils.update(
								model,
								{syncingDatabaseMsg: _p8._0, error: true});
							msg = _v3;
							model = _v4;
							continue update;
						}
				...
				case 'StopSpinner':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							...
							{syncingDatabase: false}),
						{ctor: '[]'});
				case 'SyncDatabaseLeave':
					var _p9 = A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$leave, 'sync:database', model.phxSocket);
					...
					return A2(
							...
							{phxSocket: phxSocket}),
						{
							...
							_1: {
								ctor: '::',
								_0: _user$project$Main$getCollection,
								_1: {
									ctor: '::',
									_0: A2(
										_elm_lang$core$Task$perform,
										_elm_lang$core$Basics$always(_user$project$Main$StopSpinner),
										_elm_lang$core$Process$sleep(600)),
									_1: {ctor: '[]'}
								}
							}
						});
					...
					if (_p5._0.ctor === 'Ok') {
						...
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								...
								{
									error: true,
									syncingDatabaseMsg: _elm_lang$core$Basics$toString(_p5._0._0)
								}),
							{ctor: '[]'});
					}
				case 'GetCollection':
...
var _user$project$Main$subscriptions = function (model) {
	return A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$listen, model.phxSocket, _user$project$Main$PhxMsg);
};
